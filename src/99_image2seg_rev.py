...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument("--target_category", type = str, default = 'knitwear', help='category option, selected from (jacket, cardigan, coat, jean, ...)')
        parser.add_argument("--target_color", type = str, default = "화이트")
