...
def evaluate(args):
    ...
    # cgd
    model = torch.load( os.path.join(args.output_path, 'cgd_model.pt'), map_location=cfg.MODEL.DEVICE) # only TTA test
    ...
    with open(os.path.join(args.save_folder,f'cgd_{d}.pkl'), 'wb') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_folder", type=str, default="./dataset/feature_extraction/TTA", help='cgd result path')
